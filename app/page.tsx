...
const Page = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 transition-colors relative">
                ...
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center space-x-1 lg:space-x-2">
                        ...
                        <div className="md:flex items-center space-x-4 hidden">
                            <Link 
                                href="/dashboard" 
                                className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-md text-sm font-medium transition-colors"
                            >
                                GET STARTED
                            </Link>
                        </div>
            ...
            <div className={`fixed top-0 right-0 h-full w-70 bg-gray-900 shadow-xl z-50 transform transition-transform duration-300 ease-in-out lg:hidden ${
                ...
                <div className="p-6">
                    <nav className="space-y-4">
                        <a 
                            href="#" 
                            className="block text-lg text-white hover:text-blue-400 transition-colors py-1"
                            onClick={() => setMobileMenuOpen(false)}
                        >
                            Home
                        </a>
                        ...
                        <a 
                            href="#" 
                            className="block text-lg text-white hover:text-blue-400 transition-colors py-3"
                            onClick={() => setMobileMenuOpen(false)}
                        >
                            Contact
                        </a>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-800">
                        <Link 
                            href="/dashboard"
                            className="w-full bg-gray-700 hover:bg-blue-700 text-white px-6 py-4 rounded-md font-semibold text-lg transition-colors text-center block"
                            onClick={() => setMobileMenuOpen(false)}
                        >
                            GET STARTED
                        </Link>
            ...
            <main className="flex flex-col items-center justify-center relative z-20 mt-[5vh] sm:mt-0">
                <div className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 w-full">
                    <div className="text-center max-w-3xl md:max-w-5xl mx-auto">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-10 sm:mb-8 leading-tight">
                        ...
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-10 sm:mb-12 max-w-2xl lg:max-w-3xl mx-auto leading-relaxed px-2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16 py-[3rem]">
                            <Link 
                                href="/dashboard"
                                className="w-full sm:w-auto bg-gray-700 hover:bg-gray-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-md font-semibold text-base sm:text-lg transition-colors min-w-[200px] text-center"
                            >
