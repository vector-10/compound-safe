        ...
        <div className="w-full py-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                    {/* First card - Multi-AMM Compatibility */}
                    <div className="bg-white/5 dark:bg-white/5 rounded-sm border border-gray-800 p-6 w-full md:w-1/2">
                        ...
                        <div className="relative h-48 w-full flex items-center justify-center">
                            ...
                            {/* Orbital nodes with wave animation */}
                            {[...Array(6)].map((_, i) => (
                                <div 
                                    key={i} 
                            ...
                            {/* Add more floating particles for depth */}
                            {[...Array(8)].map((_, i) => (
                                <div 
                                    key={`particle-${i}`} 
                    ...
                    {/* Second card - Dynamic Liquidity Provisioning */}
                    <div className="bg-white/5 dark:bg-white/5 rounded-sm border border-gray-800 p-6 w-full md:w-1/2">
                        <h3 className="text-xl md:text-2xl font-mono font-bold text-white mb-3">
                ...
                <div className="bg-white/5 dark:bg-white/5 rounded-xs border border-gray-800 p-6 md:p-24 w-full">
